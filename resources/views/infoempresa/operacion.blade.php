                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('empresa.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('ubicacion') ? ' has-error' : '' }}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                          ...
                                          <button type="button" class="btn btn-primary" data-dismiss="modal" id="bot">Guardar</button>
                            ...
                            <div class="col-md-2" >
                              <input id="longitud" type="text" class="form-control" name="longitud" value="{{ old('longitud') }}" required autofocus>
                            </div>
                            <div class="col-md-2">
